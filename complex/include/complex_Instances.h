...
namespace complex
{
	...
	*/
	...
	template<typename ObjT>
	concept has_valid_instances = is_divisible_by<Instance_of<ObjT>, 4>;

	/*
		Stores instances of the ObjT.
	*/
	template<has_valid_instances ObjT>
...
namespace complex
{
	class	InstancePack : private dpl::Link<InstanceGroup, InstancePack>
	{
	private: // subtypes
		using	MyLink	= dpl::Link<InstanceGroup, InstancePack>;
	...
	public: // states
		...
		public: // functions
			void		attach(				InstancePack&		pack);
			void		detach(				InstancePack&		pack);
		};
	...
	public: // commands
		...
		*/
		...
		public: // lifecycle
			...
			CLASS_CTOR		DetachCommand(	const InstancePack&		PACK);
	...
	class	InstanceGroup	: public dpl::Property<InstanceManager, InstanceGroup>
							, private dpl::Chain<InstanceGroup, InstancePack>
	...
	private: // subtypes
		using	State = InstancePack::State;
	...
	private: // functions
		void			attach_instance_pack(	InstancePack&				pack,
												std::istream*				binaryState);

		void			detach_instance_pack(	InstancePack&				pack,
	...
	{
	private: // subtypes
		using	Instance_t		= Instance_of<ObjT>;
		using	InstanceStorage	= std::conditional_t<	std::is_trivially_destructible_v<Instance_t>,
														dpl::TransferablePack<Instance_t>, 
	...
	public: // constants
		static constexpr bool IS_TRANSFERABLE = std::is_same_v<InstanceStorage, dpl::TransferablePack<Instance_t>>;
